...
If $\Lambda $ is a cocompact subgroup of $\SL(2,\Rbb)$ which is torsion free modulo $\pm 1$, and consists of purely hyperbolic elements, then the quotient $\Lambda \lmod \Hfrak$ is a compact hyperbolic surface. The un
