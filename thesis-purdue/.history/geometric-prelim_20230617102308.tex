...
\begin{proof}
  ...
  \end{align}
  with rapid convergence, uniformly in $x,y \in M$ (resp. in $M'$). Integrating along the diagonal and passing the integral through the sum, and using the fact that each $\phi_k$ has $L^2(M,v_g)$   we find
  \begin{align}
