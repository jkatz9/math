...
\end{comment}
In this section $R$ is an integral domain, and $k$ is its field of fractions, and $A$ a finite dimensional algebra over $k$. An \textbf{order} in $A$ is a subring (containing $1$) which is \begin{itemize}
	\item 
