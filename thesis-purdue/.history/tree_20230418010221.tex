...
\end{definition}
 ...
 We regard $k^2$ as a space of column vectors, with distinguished basis vectors $e_1,e_2$, so that $\GL(2,k)$ acts from the left.  We write $L_0 = Re_1+Re_2$ and refer to this as our distinguished lattice, and let $\Lambda_0 = 
