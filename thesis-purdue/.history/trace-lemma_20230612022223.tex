...
\begin{proof}
    ...
    \begin{lemma}\label{lemma:killingform}
        Let $Q: \sl(2,\kfrak_\pfrak) \to \kfrak_\pfrak$ be the quadratic form $Q(x) = \det X$. Let $\Ncal$ be the quadric in $\Pbb(\sl(2,\kfrak_\pfrak))\approx \Pbb^2(\kfrak_\pfrak)$, then $\Ncal$ is a single orbit under the projective action of $\Ad \SL(2,\kfrak_\pfrak)$.
