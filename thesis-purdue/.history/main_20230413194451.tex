...
For a pair of maximal orders $\Ocal,\Ocal'\in \Mcal$, the intersection $\Ocal,\Ocal'$ 

We say that two classes $\Lambda,\Lambda'$ are adjacent, and write $\Lambda\sim\Lambda'$ if $d(\Lambda,\Lambda')=1$. The resulting graph $(\Hcal,\sim)$ is the \textbf{Bruhat-Tits} tree for $\SL(2,k)$. 
