...
\end{align*}
and unbounded. Consequently, $\Delta$ admits a unique maximal extension  to a negative, self-adjoint, unbounded operator (which we still denote by $\Delta$) on $L^2(M,g)$ for which the resolvent $