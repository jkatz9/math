...
Let $k$ be a nonarchimedian local field of characteristic zero and residual characteristic $p$. Let $R$ be the ring of integers in $k$,   $\pfrak$ the maximal ideal of $R$, and $\kfra
