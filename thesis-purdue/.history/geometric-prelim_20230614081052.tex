...
Now suppose that $X = \Gamma \lmod G$,  where $\Gamma$ is a cocompact lattice in a semisimple Lie group $G$. Pick a Haar measure $\dop \mu$ on $G$, and define a $G$-invariant measure $\dop \mu_*(x)$ on $X$ by requiring that 
\begin{align}
