...
Then the operator $f(D)$ is of trace-class, and one can compute its trace in two ways: \begin{itemize}
    \item
\end{itemize}via its spectrum
\begin{align}
    \Tr(f(D)) = \sum_{k\geq 0} f(\lambda_k)
\end{align}
