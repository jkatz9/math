...
For now, let $k$ nonarchimedian local field of characteristic $0$, with ring of integers $R$ and maximal ideal $\pfrak$, with uniformizer $\pi$. Let $\rho : G \to \GL(2,k)$ be a representation of a group $G$ on $k \oplus k$ (acting from the left). 

Let $\Lcal$ denote the set of full $R$-lattices in $k^2$, and let $L_o = R\oplus R \in \Lcal$.   
