...
\begin{proof}
  ...
  To summarize, if $(M,g)$ is any closed Riemannian manifold which is isospectral to $\Gamma_O(\afrak) \lmod \Hfrak$, then $(M,g)$ is isometric to  $\Lambda \lmod \Hfrak$ for some finite index subgroup $\Lambda$ of $\Gamma_O = O^1 \leq A^1 \leq \SL(2,\Rbb)$. Furthermore,
