...
\begin{proof}
  ...
  Let $0 \leq \lambda_0 <\lambda_1 \leq \lambda_2 \leq \dots $ be the common set of eigenvalues, repeated according to their multiplicities, for the laplacians of $M$ and of $X(\Gamma_0(\afrak))$. Let $\{\phi_k: k\geq \}0$ (resp. $\{\psi_k: k\geq 0\}$) be an orthonormal sequence of eigenfunctions on $M$ (resp. on $X(\Gamma_0(\afrak))$) and let  
