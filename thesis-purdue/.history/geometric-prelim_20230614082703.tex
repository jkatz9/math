...
Let $\Omega \in U(\gfrak)$ be the Casimir element for $G$, viewed as an symmetric, semi-bounded, unbounded, $G$-bi-invariant operator on $\Hcal$, and let $D$ be its unique maximal self-adjoint extension. If $f : \Rbb \to \Cbb$
