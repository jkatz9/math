...
\end{comment}
In this section $R$ is an integral domain, and $k$ is its field of fractions, and $A$ a finite dimensional algebra over $k$. An \textbf{order} in $A$ is a subring $\Ocal$ of $A$ such that   
\begin{itemize}
	\item $\Ocal$ contains the subring $R 1_A$
	\item $\Ocal$ is a finitely generated $R$-module
	\item $k\Ocal = A$. 
\end{itemize}
finitely generated $R$-submodule $\Ocal$ of $A$ such that $k \Ocal = A$ 
\begin{defn}
