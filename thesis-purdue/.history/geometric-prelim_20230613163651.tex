...
Say that $A$ is of \textbf{Fuchsian-type} if $k$ is totally real, and $A$ is unramified over exactly one real place. In thise case, we use this real place to identify $k$ with a subfield of $\Rbb$, and replace
