...
\begin{proposition}[prop. E.IV.15 in]\cite{Berger.Gauduchon.Mazet-[SpectreVarieteRiemannienne]1971a}]
  Suppose  $(M,g)$ and $(M',g')$ are isospectral closed Riemannian manifolds, and that $(M,g)$ is a surface with constant scalar curvature $\kappa$. Then $(M',g')$ is also a surface with constant scalar curvature $\kappa$,
\end{proposition}
\begin{proof}
