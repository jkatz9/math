...
\end{align*}
and unbounded. As $M$ is compact and without boundary, $\Delta$ admits a unique maximal extension to a negative, self-adjoint, unbounded operator on $L^2(M,g)$ with compact resolvent. By the spectral theorem for the latter class of operators, it follows that the spectrum
\begin{align*}
    \sigma \Delta = \{ \lambda \in \Cbb : \Delta - \lambda \id \text{ is not invertible on $L^2(M,g)$}\}
\end{align*}
is a discrete set of nonnegative real numbers, accumulating at $-\infty$.