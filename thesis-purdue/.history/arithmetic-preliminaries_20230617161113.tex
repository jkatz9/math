...
Up to isomorphism, $M(2,k)$ is the unique unramified quaternion algebra over $k$.  In this case, the reduced trace and norm of an element $\alpha \in M(2,k)$ coincide with the trace and determinant maps for the action of $\alpha$ 
