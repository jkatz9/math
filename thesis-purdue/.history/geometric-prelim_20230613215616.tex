...
\end{align}
where $\tilde{M}$ is the universal cover and the metric $g^*$ is the pullback of $g$ through the universal covering map $\tilde{M}\to M$. The fundamental group $\pi_1(M)$ acts freely and cocompactly on $\tilde{M}$ by isometries 
