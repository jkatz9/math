...
There is an automorphism $\sigma \in \Gal(\tilde{K}/K)$ which induces the frobenius automorphism $x \mapsto x^q$  of $\tilde{k}/k$. % $\tilde{K}^\sigma = K$.
As $\sigma$ preserves $\tilde{R}$ and $\pi \tilde{R}$, it induces automorphisms of each $\tilde{R}_r$ which we still denote by $\sigma$.
