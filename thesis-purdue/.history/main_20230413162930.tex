...
\end{comment}
\begin{defn}
	A \textbf{free quaternion ring} over $R$ is an $R$ algebra $A$ which is a free module of rank $4$ over $R$, equipped with a standard involution such that the characteristic polynomial $\chi(x;T)$ of left multiplication by $x$ satisfies $\chi(x;T)=\mu(x;T)^2$. 
\end{defn}
