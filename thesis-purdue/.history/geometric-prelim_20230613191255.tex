...
\end{align*}
for any $R$-algebra $S$. Using the inclusion $R \to k$, we identify $\Gambf_O(R)$ with a subgroup $\Gamma_O$ of $G=\Gambf_O(k)$ For an ideal $\afrak$ of $R$, the reduction map $R \to R/\afrak$ induces an epimorpshim of groups $\Gamma \to \Gambf (R/\afrak)$
\begin{align*}
    1 \to \Gambf_O (\afrak)
\end{align*}
asdfasdf

, and similarly with $\Gamti$ and $\Gambar$.
