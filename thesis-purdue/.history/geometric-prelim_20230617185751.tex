...
\begin{proposition}[Uniformization]
  Let $(M,g)$ be a smooth compact surface with constant scalar curvature $-1$. Then there exists a cocompact lattice $\Lambda < \SL(2,\Rbb)$ which is torsion free modulo $\pm 1$, and consists only of hyperbolic elements such that $(M,g)$ is isometric to $\Lambda \lmod \Hfrak$. Up to conjugation  $\Lambda$
\end{proposition}
