...
To upgrade the pre-trace formula to the genuine trace formula, in the right hand side of \ref{eq:pretrace} we partition $\Gamma$ into its conjugacy classes $\Gamma = \bigsqcup_{\gamma\in C_\Gamma}
    \begin{align}
