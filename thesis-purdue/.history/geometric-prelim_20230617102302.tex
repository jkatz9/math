...
\begin{proof}
  ...
  \end{align}
  with rapid convergence, uniformly in $x,y \in M$ (resp. in $M'$). Integrating along the diagonal and passing the integral through the sum, and using the fact that each $\phi_k$ has $  we find
  \begin{align}
