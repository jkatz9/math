...
\end{align*}
is a model for the hyperbolic plane: the unique simply connected, complete Riemannian manifold of  The invariant volume element for this metric is given by
\begin{align*}
