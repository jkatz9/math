...
Up to isomorphism, $ M(2,k)$ is the unique unramified quaternion algebra over $k$.  In this case, the reduced trace and norm of an element $\alpha$ coincide with the trace and determinant maps for the action of $\alpha$ as an endomorphism of $k^2$.  There is a unique $A^\times = \GL(2,k)$ conjugacy class of maximal order in $A$, 
