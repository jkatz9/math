...
To upgrade the pre-trace formula to the genuine trace formula, consider the right hand side of \ref{eq:pretrace}:
\begin{align}
    \int_{\Gamma \lmod G} K_f(x,x) \dop \mu_* (x) & = \int_{\Gamma \lmod G}  \sum_{\gamma \in \Gamma} f(x^\inv \gamma x) \dop \mu^*(x)                                                                     \\
                                                  & = \int _{\Gamma \lmod G}\sum_{[\gamma] \subset \Gamma} \sum_{\gamma' \in \Gamma \rmod \Gamma_\gamma } f(x^\inv \gamma'^\inv \gamma \gamma' x ) \dop \mu_*(x) \\
                                                  & = f
\end{align}
