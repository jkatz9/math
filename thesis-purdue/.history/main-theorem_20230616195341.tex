...
\begin{proof}
  ...
  \begin{align}\label{eq:heatAsymptoticM}
    K_M(x,x,t) \sim \frac{1}{(4\pi t)^{\dim M /2 }} \sum_{k=0}^\infty u_{M,k}(x) t, \quad \text{ as $t\to 0^+$.}
  \end{align}
  ...
  \begin{align}
    \sum_{k\geq 0 }e^{-t \lambda_k} = \frac{1}{(4\pi t)^{\dim M /2 }} \sum_{k=0}^\infty u_{M,k}(x) t, \quad \text{ as $t\to 0^+$.}
  \end{align}
