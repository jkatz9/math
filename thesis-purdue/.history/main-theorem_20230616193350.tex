...
\begin{proof}
  ...
  as a function on $\Rbb_{>0} \times M\times M$  %(resp. on $\Rbb_{>0}\times X(\Gamma_0(\afrak)) \times X(\Gamma_0(\afrak))$),
   is independent of the choice of orthonormal bases of eigenfunctions, and is an  invariants of the Riemannian metric on $M$. By a theorem of Minakshisundaram and Pl \cite{Minakshisundaram.Pleijel-[PropertiesEigenfunctionsLaplaceoperator]1949}
