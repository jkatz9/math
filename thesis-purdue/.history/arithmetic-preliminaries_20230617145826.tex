...
\begin{align}
    U_S = \prod_{\nu \in S}k_\nu \times \prod_{\nu \notin S}R_\nu,
\end{align}
and topologize $\Abb_k$ such that the sets $U_S$ form a basis of open neighborhoods of $0$. With this topology, the $\Abb_k$ forms a locally compact topological ring. Furthermore, the diagonally embedded 
