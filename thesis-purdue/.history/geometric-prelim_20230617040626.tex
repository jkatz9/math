...
Let $E$ be a euclidean space, and let $\Tcal$ be the subspace of $\bigotimes^4 E^*$ of forms satisfying TC1,2,3. That is, quadralinear forms on $E$ which are alternating in the first pair and second pair of variables (sep)
