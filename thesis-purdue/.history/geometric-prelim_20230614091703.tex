...
To upgrade the pre-trace formula to the genuine trace formula, in the right hand side of \ref{eq:pretrace} we pick a set of representatives $C_\Gamma$ for the conjugacy classes of $\Gamma$, and
\begin{align}
