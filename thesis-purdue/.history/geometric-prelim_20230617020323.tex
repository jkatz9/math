...
\begin{proof}
  ...
  and  
  \begin{align}
    \frac{1}{60} \int_M \scalar_{g}^2 \dop \vol_g = \frac{1}{60} \int_{M'} \scalar^2 \dop \vol_{g'}.
  \end{align}
  By Cauchy-Schwarz, 
  \begin{align}
    \left( \int_{M'} \scalar \dop \vol_{g'} \right)^2 \leq \left( \int_{M'} \scalar^2 \dop \vol_{g'} \right)\left( \int_{M'} 1 \dop \vol_{g'} \right)
  \end{align}
  with equality if and only if $\scalar_{g'}$ 
\end{proof}
\newpage
