...
\begin{proof}
  ...
  \end{align}
  depends only on the spectrum of $M$. Consequently, integrating over $M$ in \ref{eq:heatAsymptoticM} we have
  \begin{align}
    \sum_{k\geq 0 }e^{-t \lambda_k} \sim \frac{1}{(4\pi t)^{\dim M /2 }} \sum_{k=0}^\infty \left( \int_M u_{M,k}(x) \dop \vol  \right)t^k, \quad \text{ as $t\to 0^+$.}
  \end{align}
