...
\begin{align}
  \tau(g) = 2 \log \lambda_g,
\end{align}
which in turn, can be expressed in terms of $\tr(g) = \lambda_g + \lambda_g^\inv$. Indeed, $\{\lambda_g^{\pm 1}\}$ are the roots of the characterstic polynomial $x^2 - \tr g x +1$  so that $\lambda_g^{\pm 1} = 
