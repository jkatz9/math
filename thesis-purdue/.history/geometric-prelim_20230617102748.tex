...
\end{align}
where $\scalar$, $\Ricci$, and $\Riem$ are the scalar, Ricci, and Riemannian curvature tensors. As the heat kernel $K_{M,g}(x,y,t)$ depends only on the the Riemannian structure $(M,g)$
