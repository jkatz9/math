...
\begin{proof}
    ...
    \begin{lemma}\label{lemma:killingform}
        Let $\Ncal$ be the quadric in $\Pbb(\sl(2,\kfrak_\pfrak))\approx \Pbb^2(\kfrak_\pfrak)$, cut out by the equation $det X =0$.   Then $\Ncal$ is a single orbit under the projective action of $\Ad \SL(2,\kfrak_\pfrak)$.
