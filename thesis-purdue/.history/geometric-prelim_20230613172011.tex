...
Recall that an order in a quaternion algebra $A$ over $k$ is a subring $O$ containing $R$ such that $kO = A$. For any order $O$, we affine group schemes
\begin{align*}
    \Gambfti_O = O^\times, \quad \Gambf_0 = O^1, \quad \Gambbfar_O = R^\times \lmod O^\times
\end{align*}
of $\Gbfti$, $\Gbf$, and $\Gbarbf$.
