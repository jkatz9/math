...
\begin{proposition}
    Let $A$ be a quaternion algebra over a number field $k$, and $O$ an order in $A$. If $A$ is of Fuchsian type (resp. ), then $\Gamma_O$ is a lattice in $G_\Rbb  \approx \SL(2,\Rbb)$ 
\end{proposition}
