...
\begin{proof}
  ...
  \end{align}
  as functions on $\Rbb_{>0} \times M\times M$  (resp. on $\Rbb_{>0}\times X(\Gamma_0(\afrak)) \times X(\Gamma_0(\afrak))$), are independent of the choice of orthonormal bases of eigenfunctions and are 
