...
\begin{proof}
  ...
  \end{align}
  and by our assumption that $\scalar_g$ is constant on $M$, the inequality in \ref{eq:cauchySchwarz} is an equality. Thus, the scalar curvature on $(M',g')$ is constant, and is readily seen to be equal 
\end{proof}
\newpage
