...
Let $(M,g)$ be a compact Riemannian manifold, $\tilde{M}$ its universal cover, and $\Gamma =\pi_1(M)$ its fundamental group. There is a unique metric $\puba{g}$ such that the covering map $(\Mti, \pubo{g}) \to (M,g)$ is a local isometry.  The fundamental group $\Gamma$ acts on $(\Mti,\pubo{g})$ by isometries and induces an isometric identification of $\Gamma lmod \Mti$ with $M$.
