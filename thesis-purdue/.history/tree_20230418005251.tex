...
\end{definition}
We regard $k^2$ is regarded as a space of column vectors, with standard basis vectors $e_1,e_2$.  If $L$ is a lattice in $k^2$, we write $[L]$ for its homothety class.
