...
\begin{proof}
    ...
    \begin{lemma}\label{lemma:killingform}
        Let $Q: \sl(2,\kfrak_\pfrak) \to \kfrak_\pfrak$ be the quadratic form $Q(x) = \det X$. If $a \in \kfrak_\pfrak^\times$, then $\{x \in \sl(2,\kfrak_\pfrak): Q(x) = a\}$ is a single $\Ad \SL(2,\kfrak_\pfrak)$ orbit.
    \end{lemma}
