...
\begin{proposition}\label{prop:asymptoticExpansion}
    Let $(M,g)$ be a compact $d$-dimensional Riemanniannian manifold without boundary, and let $K_t(x,y)$ be its heat kernel.  There exist a sequence of smooth functions $a_0,a_1, a_2,\cdots$ on $M$ depending on the Riemannian metric $g$ and its covariant derivates such that
