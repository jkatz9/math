...
For $g \in \GL(2,k)$ and $L$ a lattice in $k^2$, the set $gL = \{ g v : v \in L\}$ is also a lattice in $k^2$, thus yeilding an action of $\GL(2,k)$ on the set of lattices in $k^2$. This action preserves 
