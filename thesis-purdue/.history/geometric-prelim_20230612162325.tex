...
\end{proposition}
Given $x\in M$, let $\rho_x(y)$ denote the distance from $x$ to $y$ relative to the metric induced by $g$.  Then \cite{polterovichHeatInvariantsRiemannian2000}[Theorem 1.2.1]
