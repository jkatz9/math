...
\end{proof}
\begin{proposition}
  Let $(M,g)$ be a closed Riemannian manifold of dimension $3$ with constant sectional curvature $\sigma$. If $(M',g')$ is Laplace-isospectral to $(M,g)$ then $(M',g')$ is also a 
\end{proposition}
