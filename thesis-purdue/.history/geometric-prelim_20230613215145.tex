...
% [OVEREXPOSITING?]
If $(M,g)$ is a compact Riemannian manifold of dimension $2$ with constant scalar curvature $-1$, then there exists an isometry $(\tilde{M},g^*) \to (\Hfrak , g_\hyp)$ where $\tilde{M}$ is the universal cover with pullback metric $\tilde
