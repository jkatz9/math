...
\begin{proof}
  Suppose $M$ is a closed Riemannian manifold which is isospectral to $X(\afrak)$. Let $0 \leq \lambda_0 <\lambda_1 \leq \lambda_2 \leq \dots $ be the common set of eigenvalues, repeated according to their multiplicities, for 
