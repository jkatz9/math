...
\end{align*}
and unbounded. As $M$ is compact and without boundary, $\Delta$ admits a unique maximal extension  to a negative, self-adjoint, unbounded operator (which we still denote by $\Delta$) on $L^2(M,g)$ for which the resolvent $R(\Delta,\Lambda)= (\Delta - \lambda)^\inv$