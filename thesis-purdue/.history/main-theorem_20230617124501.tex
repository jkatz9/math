...
\begin{proof}
  Suppose $M$ is a closed Riemannian manifold which is isospectral to $X(\Gamma_O(\afrak))$. Then 
  ...
  \end{align}
  we find that the quantities $\dim M$ and $\int_M u_{M,k}(x) \dop \vol_M(x)$ depend only on the spectrum of $M$. Carying out the same computations for $X(\Gamma_0(\afrak))$ we find that
  \begin{align}
    \dim M = \dim X(\Gamma_0(\afrak)),
  \end{align},
  and by integrating over $M$ and $X(\Gamma_0(\afrak))$ we find
  \begin{align}
    \vol M                                                                      & = \vol X(\Gamma_0(\afrak))                                                                       \\
    \int_M \scalar                                                              & = \int_{X(\Gamma_0(\afrak))} \scalar                                                             \\
    \int_M  \left( 2\Norm{R(x)}^2 -2 \Norm{\Ricci(x)}^2 +5 \scalar^2(x) \right) & = \int_{X(\Gamma_0(\afrak))} \left( 2\Norm{R(x)}^2 -2 \Norm{\Ricci(x)}^2 +5 \scalar^2(x) \right)
  \end{align}
  % \begin{align}
  %   \vol M = \int_{M}1  =  \int_{X(\Gamma_0(\afrak))} 1   = \vol  X(\Gamma_0(\afrak)).
  % \end{align}
  from \ref{eq:heatone}
