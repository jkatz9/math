...
We write $\spec (M,g)$ for the sequence $0 = \lambda_0 < \lambda_1 \geq \lambda_2 \leq \cdots $ of eigenvalues of $\Delta$ acting on $C^\infty(M)$, repeated according to multiplicity. For $\lambda \in \Cbb$
