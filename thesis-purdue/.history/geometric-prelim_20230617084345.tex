...
\end{align}
where $x,y,z,w \in T_p M$. If $x^1,...,x^d$ is a coordinate system about $p$, one writes
\begin{align}
  \Riem (\frac{\partial}{\partial x^h}, \frac{\partial}{\partial x^i})\frac{\partial}{\partial x^j} = \sum_l R^l_{jhi} \frac{\partial}{\partial x_l}
\end{align}
and
\begin{align}
  Q_{hijk} = g(\Riem(\frac{\partial}{\partial x_h},\frac{\partial}{\partial x_i})\frac{\partial}{\partial x_j}, \frac{\partial}{\partial x_k}) = \sum_l g_{lk}\Riem
\end{align}
% \begin{comment}
% This
