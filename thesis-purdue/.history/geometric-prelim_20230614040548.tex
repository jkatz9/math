...
Let $(M,g)$ be a closed Riemannian manifold.  Within each free homotopy class of closed curve $\gamma$ on $M$, there is a geodesic $\hat{\gamma}$ representative for which the length $\ell_g(\gamma)$ 
