...
If $g$ is hyperbolic, then modulo $\pm 1$, it is conjugate to a unique matrix  of the form $\Tbt{\lambda_g}{}{}{\lambda_g^\inv }$ where $\lambda_g \in \Rbb_{>0}$ and $\lambda_g > \lambda_g^\inv$. In this case, the translation length $\tau(g)$ is related to $\lambda_g$ by the 
