...
\end{align*}
acts isometrically and $2$-transitively $(\Hfrak,\dop s^2)$  via linear fractional transformations
\begin{align*}
  \Tbt{a}{b}{c}{d} z = \frac{az+b}{cz+d} %= \frac{ac |z|^2 +(ad+bc)\re z  +bd}{|cz+d|^2} + i \frac{\im z}{|cz+d|^2}
\end{align*}
where $\tbt{a}{b}{c}{d} \in \SL(2,\Rbb)$.  This action factors through $\PSL(2,\Rbb)$ which can be identified with the full group of orientaton preserving isometries of $(\Hfrak,\dop s^2)$.
