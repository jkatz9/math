...
Let $\Omega \in U(\gfrak)$ be the Casimir element for $G$, viewed as an symmetric, semi-bounded, unbounded, $G$-bi-invariant operator on $L^2(\Gamma \lmod G,\dop \mu^*)$, and let $D$ be its unique maximal extension to self-adjoint unbounded operator
