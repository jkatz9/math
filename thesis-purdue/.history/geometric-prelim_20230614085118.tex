...
\end{align}
We extend the group representation $U_\Gamma : G \to \Aut(L^2(X))$ to an algebra representation $U_\Gamma: L^1(G)\to \End(L^2(X))$ by the rule $(U_\Gamma(f)) \phi(x) = \int_G f(y)\phi(g) \dop \mu (x)$.
