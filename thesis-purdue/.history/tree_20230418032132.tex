...
Let $G$ be a group, and $\rho: G \to \GL(2,k)$ be a representation. Then $G$ acts (through $\rho$) on $\Tcal$, and the set of fixed points $\Tcal(\rho)$ is a (possibly empty) connected subtree of $\Tcal$.  \cite{bellaicheSousgroupesGLArbres2014}
