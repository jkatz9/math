...
\end{comment}
In this section $R$ is an integral domain, and $k$ is its field of fractions, and $A$ a finite dimensional algebra over $k$. An \textbf{order} in $A$ is a finitely generated $R$-submodule $\Ocal$ of $A$ s
\begin{defn}
