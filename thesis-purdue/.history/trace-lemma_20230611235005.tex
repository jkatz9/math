...
\begin{proof}
    ...
    \begin{lemma}\label{lemma:killingform}
        ...
        \begin{itemize}
            ...
            \item Let $\Ncal$ be the image of $\{x \in \sl(2,\kfrak_\pfrak) \setminus 0:  Q(x)=0\}$ in $\Pbb(\sl(2,\kfrak_\pfrak))\approx \Pbb^2(\kfrak_\pfrak)$, then $\Ncal$ is a single orbit under the projectivization of $\Ad \SL(2,\kfrak_\pfrak)$.
        \end{itemize}
