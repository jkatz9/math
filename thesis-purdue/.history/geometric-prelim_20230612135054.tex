...
\end{align*}
and unbounded. As $M$ is compact and without boundary, $\Delta$ admits a unique maximal extension to a negative, self-adjoint, unbounded operator on $L^2(M,g)$ with compact resolvent. By the spectral theorem for the latter class of operators, it follows that the