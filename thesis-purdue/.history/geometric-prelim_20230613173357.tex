...
\end{align*}
for any $R$-algebra $S$. Using the inclusion $R \to k$, we identify $\Gambf_O(R)$ with a subgroup $\Gamma_O$ of $G=\Gambf_O(k)$, and similarly with $\Gamti$ and $\Gambar$. For an ideal $\afrak$ of $R$,
