...
% [OVEREXPOSITING?]
If $(M,g)$ is a compact Riemannian manifold of dimension $2$ with constant scalar curvature $-1$, then there exists an isometry $$, where $\tilde{M}$ is the universal cover with pullback metric $g^*$, such that 
