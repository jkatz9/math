...
Let $(M,g)$ be a compact Riemannian manmifold. The eigenvalues of the Laplace operator of the Laplace operator $\Delta_{M,g}$ acting on $L^2(M,\dop \vol_g)$ form a discrete $0 = \lambda_0 < \lambda_1 \leq \lamda_2 \leq \dots$ which we encode via the discrete measure $\spec_{M,g}
