...
\begin{proof}
  ...
  From Selberg's trace formula[TODO], the Laplace spectrum of  of $\Lambda \lmod \Hbb^2$ for a cocompact Fuchsian group (resp. $\Lambda \lmod \Hbb^3$ for a cocompact Kleinian group) determines (and is determined by) the length spectrum (resp. complex length spectrum), 
