...
We let $\tilde{K}$ denote the maximal unramified extension of $K$ in some fixed algebraic closure, $\tilde{R}$ its ring of integers, and $\tilde{k}$ its residue field. We note that $\varpi$ generates the maximal
