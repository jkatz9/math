...
\end{proposition}
\begin{proof}
 For any Riemannian surface $(M',g')$, one has $|\Ricci|^2 = \frac{\scalar^2}{2}$ and $\Norm{R}^2 = 2 \Norm{\Ricci}^2 = \scalar^2$. Thus, the universal expression for the second term in the heat kernel asymptotic expansion is
  \begin{align}
