...
Set $\Gbf = \GL_n (\Rti)$. For $r\geq 1$, set $\Gbf(r) = \GL_n(\Rti_r)$. We write $\eta_r: \Gbf \to \Gbf(r)$ for the natural projection, and set $\Kbf_r  = \ker \eta_r \leq \Gbf$.  For $r \geq i \geq 1$  write $\eta_i^r : \Gbf(r) \to \Gbf(i)$ for the natural projection, and set $\Kbf_r^i = \ker \eta_i \leq \Gbf$. For $i\geq r \geq 1$, let $\eta_i^r
