...
Let $k$ be a nonarchimedian local field of characteristic zero and residual characteristic $p$. Let $R$ be the ring of integers in $k$, and $\pfrak$ be the maximal ideal 
