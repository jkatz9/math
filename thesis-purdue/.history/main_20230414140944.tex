...
We view $A$ as four dimensional affine space over $F$, and write $F[A]$ for its coordinate ring. We let $A^\times$ act on $F[A]$ by precomposing with the conjugation action. Then the functions $\trd$, $\nrd$ are regular map
