...
Set $\Gbf = \GL_n (\Rti)$ and $\Gbf(r) = \GL_n(\Rti_r)$ for $r\geq 1$. For $i\geq 1$, write $\eta_i : \Gbf \to \Gbf(i)$ for the natural projection, and set $\Kbf_i = \ker \eta_i \leq \Gbf$. For $i\geq r \geq 1$,
