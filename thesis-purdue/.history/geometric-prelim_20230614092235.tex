...
\end{align}
Letting $\Gamma_\gamma$ denote the centralizer of $\gamma$ in $\Gamma$,  we then identify each conjugacy class on the RHS of \ref{eq:conjclass} with the quotient $\Gamma \rmod \Gamma_\gamma$. Now
