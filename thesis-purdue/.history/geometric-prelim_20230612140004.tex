...
\begin{align*}
    \sigma \Delta = \{ \lambda \in \Cbb : \Delta - \lambda \id \text{ is not invertible on $L^2(M,g)$}\}
\end{align*}
is a discrete set of nonnegative real numbers, accumulating at $-\infty$, and consists of eigenvalues of $\Delta$ with finite multiplicites. By elliptic regularity,