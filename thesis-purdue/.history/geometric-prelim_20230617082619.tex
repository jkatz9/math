...
\paragraph{Curvature}
Let $(M,g)$ be a Riemannian manifold of dimension $d$, and write $\nabla$ Levi-Civita connection for the metric $g$. The Riemannian curvature tensor $R$
\begin{comment}
This means that $\nabla$ satisfies $\nabla_X \frac{\partial}{\partial x^i} =0$ for any vector field $X$ and any coordinate system $x^i$.
\end{comment}
