...
\begin{align*}
    \dop \vol_{\hyp} = \frac{\dop x \dop y}{y^2},
\end{align*}
...
% [OVEREXPOSITING?]
If $(M,g)$ is a compact Riemannian manifold of dimension $2$ with constant scalar curvature $-1$, then there exists an isometry $(\tilde{M},g) \to
