...
\begin{facts}
    ...
    \begin{enumerate}
        ...
        \item If $O,O'$ are orders in quaternion algebras $A,A'$ over number fields $k,k'$ with $A_\Kbb = A'_\Kbb$ such that $\Gamma_O$ is commensurable to $\Gamma_O'$ in $A_\Kbb^1 = A'_\Kbb^1$ then $k=k'$ and $A = A'$. Consequently, the 
        \item
