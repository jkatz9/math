...
\begin{proposition}\label{prop:asymptoticExpansion}
    ...
    as $t \to 0^+$.
\end{proposition}
For each $n$, the function $a_n$ is a homogeneous polynonmial of degree $2n$ in the derivatives of the metric $g$ at $x$. For the purposes of this paper, we will make use of an explicit description of the first few: $\abf_0$
