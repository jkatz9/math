...
\begin{proof}
  ...
  \end{align}
\end{proof}
\begin{corollary}\label{cor:dimVol}
...
\begin{proposition}[prop. E.IV.15 in]\cite{Berger.Gauduchon.Mazet-[SpectreVarieteRiemannienne]1971a}]\label{prop:curvatureTwoManifolds}
...
\begin{proposition}\cite[prop. E.IV.18 of]{Berger.Gauduchon.Mazet-[SpectreVarieteRiemannienne]1971a}\label{prop:curvatureThreeManifolds}
