...
\begin{proof}
  ...
  \end{align}
  with rapid convergence, uniformly in $x,y \in M$ (resp. in $M'$). Integrating along the diagonal and passing the integral through the sum, we find
  \begin{align}
    \int_M K_{M,g}(x,y,t) \dop v_g  = \sum{k\geq 0}e^-t \lambda_k \int \phi_k^2(x)\dop v_g = \sum_{k\geq 0}e^
  \end{align}
