...
\begin{proof}
    ...
    To complete the proof for $\pfrak \notin \Ram A$, we repeat the argument of the base case to replace $\alpha_o$ with an element $A^\times$.

    Now suppose that $\pfrak \in \Ram A$.
