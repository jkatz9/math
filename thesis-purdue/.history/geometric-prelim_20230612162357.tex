...
\end{proposition}
Given $x\in M$, let $\rho_x(y)$ denote the distance from $x$ to $y$ relative to the metric induced by $g$.  Then one may express the heat invariants $a_n(x)$ by the formulae \cite{polterovichHeatInvariantsRiemannian2000}[Theorem 1.2.1]
