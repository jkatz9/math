...
\begin{claim}	
	If $x\in A$ is central, then $F[x] = F$. Otherwise, for noncentral $x\in A$, with $\delta = \delta(x)$,
	\begin{align*}
	...
	as $F$-algebras. 
\end{claim}
We say a noncentral element $x$ is split semisimple, nonsplit semisimple, or parabolic correspondingly.

\begin{claim}
	If $x$ is noncentral, then the centralizer of $x$ in $A^\times$ is $F[x]^\times$. 
\end{claim}
