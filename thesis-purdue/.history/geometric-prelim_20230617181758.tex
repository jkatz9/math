...
If $g$ is hyperbolic then there exists a unique complete geodesic $\gamma_g$ in $\Hfrak$ such that, for all $x \in \gamma_g$, one has $\dist(x,gx) = \tau(g)$. We call $\gamma_g$ the \textbf{axis} 
