...
\end{description}
The action of $\SL(2,\Rbb)$ on $\Hfrak$ is transitive. For example, the element $\tbt{y^{1/2}}{xy^{-1/2}}{0}{y^{-1/2}}$ maps $i$ to $x+iy$. The stabilizer in $\SL(2,\Rbb)$ of $i$ is the maximal compact subgroup
\begin{align*}
