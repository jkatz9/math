...
Fix a point $m\in M$, and let $P \in G_m^2 M$ be a $2$-plane in $T_mM$. Pick a basis $\{x,y\}$ for $P$ and define the sectional curvature:
\begin{align}
  \sigma(x,y) = \frac{R(x,y,x,y)}{|x \wedge y|^2}
\end{align}
