...
\end{align}
is independent of the choice of basis $u,v$ of $P$. Thus $K_p$ defines a function on the Grassmanian $G^2_p M$  of $2$-planes in $T_p^M$, and is called the \textbf{sectional}
