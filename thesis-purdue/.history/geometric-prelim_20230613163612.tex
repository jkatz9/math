...
Say that $A$ is of \textbf{Fuchsian-type} if $k$ is totally real, and $A$ is unramified over exactly one real place. In thise case, we use this unique place to identify
