...
We say that two classes $\Lambda,\Lambda'$ are adjacent, and write $\Lambda\sim\Lambda'$ if $d(\Lambda,\Lambda')=1$. The resulting graph $(\Hcal,\sim)$ is model of for the \textbf{Bruhat-Tits} tree for $\SL(2,k)$.
